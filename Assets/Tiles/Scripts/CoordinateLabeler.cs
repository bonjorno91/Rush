...
namespace Tiles
{
    ...
    public class CoordinateLabeler : MonoBehaviour
    {
        ...
        private void UpdateCoordinates()
        {
            ...
            var x = Mathf.RoundToInt(gameObject.transform.parent.position.x / EditorSnapSettings.move.x).ToString();
            var y = Mathf.RoundToInt(gameObject.transform.parent.position.z / EditorSnapSettings.move.z).ToString();
